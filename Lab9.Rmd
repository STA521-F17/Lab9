...
- Download the latest JAGS from [here](https://sourceforge.net/projects/mcmc-jags/files/JAGS/)

- [Here](http://www.jkarreth.net/files/bayes-cph_Tutorial-JAGS.pdf) is a good online tutorial with lots of demos. This tutorial also walks you through installing JAGS on your local machine step by step
...
For more details on DIC, see wikipedia [here](https://en.wikipedia.org/wiki/Deviance_information_criterion).
